 ...
 */
    ...
    #define LED1_INDICATION_MSG 0x0201   /* 11 bit SID */

/* This message ID is not used in the RTR reference design */
    #define CAN2_MSG_ID         0x0204   /* 11 bit SID */
#endif
 ...
 *   is set with Mask 0 for EID LED1_INDICATION_MSG. Only RXNEMPTY interrupt
 *   and RBIF interrupt is enabled.
 * Precondition:    None.
 * Parameters:      None.
 * Return Values:   None.
 * Remarks:         None.
 ...
 * 
 * Precondition:   None.
 * Parameters:     ed1Indication - 1 to switch on LED4, 0 to switch it off.
 * Return Values:  None.
 *
 * Remarks:       None.
